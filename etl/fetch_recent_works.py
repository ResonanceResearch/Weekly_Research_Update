...
from openalex_utils import (
    normalized_faculty_from_csv, dates_last_n_days, collect_recent_works_for_authors,
...
def main():
    ...
    for wid, w in works_map.items():
        ...
        results.append({
            ...
            "authorships": authors,
            "cohort_matches": matches,   # includes 'email' now (if present in CSV)
            "abstract_inverted_index": abstract_inv,
            "abstract_text": abstract_text,                 # full
            "abstract_snippet_250w": abstract_snippet_250w, # GPT prompt
